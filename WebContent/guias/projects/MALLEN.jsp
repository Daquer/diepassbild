...
<script type="text/javascript">
	$(document).ready(function() {
		var pastaProjeto = "../../images/guias/projetos/Mallen";
		var numFotos = 13;
	...
	<div class="wrapper">
		...
		<div class="innerwrapper">
			...
			<div class="detalhe-projetos">
				...
				why a fat woman is rarely portrayed? why a naked fat woman bothers you so much? why minorities have little visibility in photographic projects? why media believes that is still valid spreading a fake and destructive image of what being woman is?<br /><br />
				
				I could write about how the concept of this series was important once it has been inspired by pagan goddesses, but I really do not want because I'm sick of it all. I want to be able to convey what actually be a woman means, I want to introduce the brutal force that we have developed to survive in this world every day and I want to be seen first of all as a woman and not as a visual object with millions of editing layers in my body.<br /><br />
 
				that's the point of this project: female empowerment. simple like that.<br /><br />
				
				camera: yashica 108 mp.<br /> <br /> 
				
				film: kodak portra 160.<br /><br />
				
				location: joinville, sc, br.<br /><br />
