...
<script type="text/javascript">
	$(document).ready(function() {
		var pastaProjeto = "../../images/guias/projetos/Pink";
		var numFotos = 6;
...
<!-- 				<img src="../images/guias/manifesto 02.jpg" style="width: 1000px;" /> -->
				...
				FEMALE PINK (2014).
				<br /><br />
				an essay connected to the questioning about beauty stereotypes established to the female body + the redemption of female empowerment.<br /><br />

				camera: yashica 108 multiprogram film: kodak ektachrome 160T.
