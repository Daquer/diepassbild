...
<script type="text/javascript">
	$(document).ready(function() {
		var pastaProjeto = "../../images/guias/projetos/Goddesses of the Nature";
		var numFotos = 8;
...
<!-- 				<img src="../images/guias/manifesto 02.jpg" style="width: 1000px;" /> -->
				<br />
				GODDESSES OF THE NATURE (2015).
				<br /><br />
				the most powerful elements of nature controlled by the purest form of creation: the female body.<br /><br />

				cameras: yashica 108 multiprogram / lomo smena 7.<br /><br />

				films: kodak proimage 100 / fuji superia 200.<br /><br />
